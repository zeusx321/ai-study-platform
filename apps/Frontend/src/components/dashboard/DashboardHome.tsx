    ...
    <main className="flex-1 h-[calc(100vh-40px)] overflow-y-auto text-white my-[20px] border border-[#666565]/50 rounded-lg px-[45px] py-[35px] mx-[20px] relative">
      ...
      <div className="mx-auto flex min-h-full w-full max-w-[860px] flex-col items-center justify-center py-16">
        ...
        <button
          ...
          className="mt-9 flex w-full max-w-[560px] items-center gap-3 rounded-full border border-[#666565]/50 bg-white/[0.04] px-3 py-2 text-left text-[#9ca3af] transition-colors hover:border-[#8b5cf6]/70 hover:bg-white/[0.06]"
        >
          <span className="flex h-8 w-8 items-center justify-center rounded-full bg-white/10 text-white">
            <Plus className="h-4 w-4" />
          </span>
          <span className="min-w-0 flex-1 text-[14px]">tell us...</span>
          <span className="flex h-8 w-8 items-center justify-center rounded-full bg-white/10 text-white">
        ...
        <section className="mt-10 w-full">
          <div className="mb-4 flex items-center gap-2 text-[15px] text-[#d1d5db]">
            <span>Recent</span>
              ...
              {recentPages.map((page) => (
                ...
                >
                  ...
                  <div className="relative px-6 pb-5 pt-9">
                    ...
                    <h2 className="truncate text-[18px] font-semibold text-white">{page.title || "Untitled"}</h2>
                  </div>
                </button>
              ))}
            </div>
